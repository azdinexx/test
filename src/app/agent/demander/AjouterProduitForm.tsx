...
function AjouterProduitForm({ id }: { id: string }) {
  ...
  return (
    <>
      {state?.error && (
        <div className="text-red-500 text-center mt-3">{state.error}</div>
      )}
      <form
        action={action}
        className="py-3 mb-3 flex gap-4 text-sm items-center bg-blue-50/70 p-4 rounded-md mt-3"
      >
